...
import { Telescope, Target, Bug, FileCheck } from 'lucide-react';
...
const steps = [
  {
    icon: Telescope,
    title: 'Discovery',
    description: 'We analyze your infrastructure and define the scope of testing'
  },
  {
    icon: Target,
    title: 'Exploitation',
    description: 'Our experts identify and safely exploit vulnerabilities'
  },
  {
    icon: Bug,
    title: 'Analysis',
    description: 'Detailed examination of security weaknesses and their impact'
  },
  {
    icon: FileCheck,
    title: 'Reporting',
    description: 'Comprehensive report with remediation recommendations'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            A systematic approach to uncovering and addressing security vulnerabilities
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-black/50 border border-cyan-500/30 rounded-lg p-8 text-center relative z-10 group hover:border-cyan-500 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 h-full flex flex-col">
                <motion.div
                  className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 mb-6 relative"
