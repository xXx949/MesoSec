      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-8 left-8 z-50 bg-gradient-to-r from-cyan-500 to-blue-500 text-white p-4 rounded-full shadow-lg shadow-cyan-500/50 hover:shadow-cyan-500/70 transition-all duration-300 group"
          >
            <motion.div
              animate={{
                rotate: [0, 10, -10, 0],
                ...
                <div className="flex flex-wrap gap-2">
                  {quickReplies.map((reply) => (
                    <button
                      ...
                      className="text-xs bg-slate-900 border border-cyan-500/30 text-cyan-400 px-3 py-1 rounded-full hover:bg-cyan-500/10 hover:border-cyan-500/50 transition-all"
                    >
                      {reply}
                    </button>
                  ))}
